...
(:objects
    stringd_box1 stringd_box2 stringd_box3 stringd_box4  - box_stringd
...
(:init
    ...
    (at 390.0 (box_at stringd_box1 stringd_ec))
    (at 420.0 (not (on_time stringd_box1)))
    (on_time stringd_box1)
    (associated_lab stringd_box1 stringd_labinter)
    (= (weight stringd_box1) 20)

    (at 390.0 (box_at stringd_box2 stringd_ec))
    (at 420.0 (not (on_time stringd_box2)))
    (on_time stringd_box2)
    (associated_lab stringd_box2 stringd_labinter)
    (= (weight stringd_box2) 20)

    (at 360.0 (box_at stringd_box3 stringd_pad))
    (at 390.0 (not (on_time stringd_box3)))
    (on_time stringd_box3)
    (associated_lab stringd_box3 stringd_labpol)
    (= (weight stringd_box3) 20)

    (at 360.0 (box_at stringd_box4 stringd_pp3))
    (at 390.0 (not (on_time stringd_box4)))
    (on_time stringd_box4)
    (associated_lab stringd_box4 stringd_labpol)
