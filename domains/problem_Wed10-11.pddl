...
(:objects 
    stringd_box1 stringd_box2 stringd_box3 stringd_box4 stringd_box5 stringd_box6  - box_stringd 
    foxizirc robin  - robot 
    stringd_labpol stringd_labinter  stringd_pad stringd_ec   stringd_opsm     stringd_pebd stringd_pp3   stringd_cog1 stringd_compuestos  - placeid_stringd 
...
(:init
    ...
    (at 600.0 (box_at stringd_box1 stringd_ec))
    (at 630.0 (not (on_time stringd_box1)))
    (on_time stringd_box1)
    (associated_lab stringd_box1 stringd_labinter)
    (= (weight stringd_box1) 20)
    
    (at 600.0 (box_at stringd_box2 stringd_ec))
    (at 630.0 (not (on_time stringd_box2)))
    (on_time stringd_box2)
    (associated_lab stringd_box2 stringd_labinter)
    (= (weight stringd_box2) 20)
    
    (at 630.0 (box_at stringd_box3 stringd_ec))
    (at 660.0 (not (on_time stringd_box3)))
    (on_time stringd_box3)
    (associated_lab stringd_box3 stringd_labinter)
    (= (weight stringd_box3) 20)
    
    (at 630.0 (box_at stringd_box4 stringd_ec))
    (at 660.0 (not (on_time stringd_box4)))
    (on_time stringd_box4)
    (associated_lab stringd_box4 stringd_labinter)
    (= (weight stringd_box4) 20)
    
    (at 600.0 (box_at stringd_box5 stringd_pad))
    (at 630.0 (not (on_time stringd_box5)))
    (on_time stringd_box5)
    (associated_lab stringd_box5 stringd_labpol)
    (= (weight stringd_box5) 20)
    
    (at 600.0 (box_at stringd_box6 stringd_pp3))
    (at 630.0 (not (on_time stringd_box6)))
